INSERT INTO day_glance_bucketed_orc
select
  a.glanceid,
  a.Userid,
  a.glancestarttime,
...
from `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.glance_ended`
...
from `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.cta_started`
where process_date = date({})
and apikey in ('4f2b0052677b39f442a43747df880c2c','30aedfec48ddd7c42cb8cd855b431a774a0d6b17','00841810b5ff444c03ace404b9458667')
...
where (case when c.sessionmode = 'HIGHLIGHTS' and c.glancestartsource = 'LS' then a.glanceduration > 500 else TRUE END))a
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.cta_started`
    where
      process_date = date({})
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.peek_ended`
    where
      process_date = date({})
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.peek_started`
    where
      process_date = date({})
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.video_ended`
    where
      process_date = date({})
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.video_started`
    where
      process_date = date({})
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    SELECT
      ...
      COUNT(*) as like_count
    from
      `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.glance_like`
    where
      process_date =date({})
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.glance_shared`
    where
      process_date = date({})
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
...
max(cityid) as cityid,
count(*) as glance_count
from `glancecdn-sandbox-c32a:GlanceAnalyticsDataInMobi.glance_started`
where process_date =  date({})
