...
INSERT INTO hive.glancedb.output_orc_table
select
a.glanceid,
a.Userid,
a.glancestarttime,
...
from hive.glancedb.glance_ended
where process_date = date('2021-06-23') and hour = 5
...
from hive.glancedb.glance_started
where process_date = date('2021-06-23') and hour = 5
and apikey in ('4f2b0052677b39f442a43747df880c2c','30aedfec48ddd7c42cb8cd855b431a774a0d6b17','00841810b5ff444c03ace404b9458667')
...
where (case when c.sessionmode = 'HIGHLIGHTS' and c.glancestartsource = 'LS' then a.glanceduration > 500 else TRUE END))a
    where
    process_date = date('2021-06-23') and hour = 5
    and apikey in (
