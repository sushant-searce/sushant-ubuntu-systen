INSERT INTO `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.day_glance_bucketed_output1`
select
  a.glanceid,
  a.Userid,
  a.glancestarttime,
...
from `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_glance_ended`
...
from `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_glance_started`
where process_date = date('2021-06-23')
and apikey in ('4f2b0052677b39f442a43747df880c2c','30aedfec48ddd7c42cb8cd855b431a774a0d6b17','00841810b5ff444c03ace404b9458667')
...
where (case when c.sessionmode = 'HIGHLIGHTS' and c.glancestartsource = 'LS' then a.glanceduration > 500 else TRUE END))a
  ...
  left join (
    SELECT
      ...
      count(*) as cta_count
    from
      `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_cta_ended`
    where
      process_date =date('2021-06-23')
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_cta_started`
    where
      process_date = date('2021-06-23')
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_peek_ended`
    where
      process_date = date('2021-06-23')
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_peek_started`
    where
      process_date = date('2021-06-23')
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_video_ended`
    where
      process_date = date('2021-06-23')
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_video_started`
    where
      process_date = date('2021-06-23')
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    SELECT
      ...
      COUNT(*) as like_count
    from
      `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_glance_like`
    where
      process_date =date('2021-06-23')
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
  ...
  left join (
    ...
    from
      `glancecdn-sandbox-c32a.glance_inmobi_analytics_poc.hour_glance_shared`
    where
      process_date = date('2021-06-23')
      and apikey in (
        '4f2b0052677b39f442a43747df880c2c',
