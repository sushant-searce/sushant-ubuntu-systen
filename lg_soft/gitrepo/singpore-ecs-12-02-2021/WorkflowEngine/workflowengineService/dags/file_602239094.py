...
context = {'user': 'mohan.paralla', 'team': 'Proactive Customer Care Task', 'department': 'Cloud Solution Department', 'executionId': '602239094'}
def read_deployment_yaml():
    file_name= "public/airflow/definationyaml/602239094/definition.yaml"
...
def on_failure_callback(context):
    ...
    payload1 = '{"workflow_execution_id" : "602239094"}'
...
def update_stopped_status(**kwargs):
    ...
    payload = '{"workflow_execution_id" : "602239094"}'
    ...
    if task_type == "Task":
        if resource_type == 'arn:aws:states:::lambda:invoke':
            ...
            if ecs_type =='ecs':
                ...
                dynamicTask = ECSEC2ALLOperatorBuilder().getOperator(dag, task_id, states)
