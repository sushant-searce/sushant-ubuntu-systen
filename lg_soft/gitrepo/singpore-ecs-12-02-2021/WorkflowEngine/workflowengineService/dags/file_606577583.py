...
context = {'user': 'mohan.paralla', 'team': 'Proactive Customer Care Task', 'department': 'Cloud Solution Department', 'executionId': '606577583'}
def read_deployment_yaml():
    file_name= "public/airflow/definationyaml/606577583/definition.yaml"
...
def on_failure_callback(context):
    ...
    payload1 = '{"workflow_execution_id" : "606577583"}'
...
def update_stopped_status(**kwargs):
    ...
    payload = '{"workflow_execution_id" : "606577583"}'
