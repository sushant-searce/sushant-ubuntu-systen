...
context = {'user': 'mohan.paralla', 'team': 'Proactive Customer Care Task', 'department': 'Cloud Solution Department', 'executionId': '686099528'}
def read_deployment_yaml():
    file_name= "public/airflow/definationyaml/686099528/definition.yaml"
...
def on_failure_callback(context):
    ...
    payload1 = '{"workflow_execution_id" : "686099528"}'
...
def update_stopped_status(**kwargs):
    ...
    payload = '{"workflow_execution_id" : "686099528"}'
