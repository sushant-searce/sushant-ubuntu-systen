...
#         },
#         'step_execution': {
#             'NotifyFailure': Pass(state_id="NotifyFailure"),
#             'NotifySuccess': Pass(state_id="NotifySuccess"),
#             'DataLoader': DummyState()
#         }
#
#     }
#     with open('../config-new/choice_1234.yaml', 'r') as f:
#         definition = yaml.full_load(f)
#         step = ChoiceStepBuilder.getStep(None, context, definition)
#         print(step)
#
#
# main()
