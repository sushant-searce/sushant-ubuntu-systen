...
#         },
#         'step_execution': {
#             'BatchInference1': Pass(state_id="BatchInference1"),
#             'BatchInference2': Pass(state_id="BatchInference2")
#         }
#
#     }

#     with open('../config-new/parallel_state_1234.yaml', 'r') as f:
#         definition = yaml.full_load(f)
#         step = ParallelStepBuilder.getStep(None, context, definition)
#         print(step)
#
#
# main()
