...
ORG_MGMT_TABLE = os.environ.get('ORG_MGMT_TABLE') or 'OrgManagement-prauf2yhyjfdlh2lrtw54aceiq-virgnia'

NOTIFICATION_TOPIC = os.environ.get('NOTIFICATION_TOPIC')
FARGATE_CLUSTER =  os.environ.get('FARGATE_CLUSTER')
ECS_EC2_CLUSTER = os.environ.get('ECS_EC2_CLUSTER') or 'ecs-ec2'
ECS_INSTANCE_LIST=os.environ.get('ECS_INSTANCE_LIST')
...
FINAL_STEP = os.environ.get('FINAL_STEP') or "arn:aws:lambda:ap-southeast-1:797237262327:function:Project_Completion_Step"
#LOG_GROUP = "/ecs/ecsTask"
LOG_GROUP = os.environ.get('LOG_GROUP') or "/ecs/ecsTask"
...
#PROJECT_COMPLETION_FUNCTION_ARN=os.environ.get('PROJECT_COMPLETION_FUNCTION_ARN')
