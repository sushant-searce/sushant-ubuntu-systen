...
public class RCT_31 {
	...
	public static void main(String[] args) {
		...
		System.out.println("RCT  => REF_REC_TYPE = '31'");
		...
		Dataset<Row> RCT31 = MRCT.select(MRCT.col("REF_CODE"), MRCT.col("REF_DESC"))
				.filter(MRCT.col("REF_REC_TYPE").equalTo(31))
...
//		RCT32.show();
		...
		Dataset<Row> RCT_31_DF  = RCT31.flatMap(new FlatMapFunction<Row, Row>() {
            ...
            public Iterator<Row> call(Row record) throws Exception {
                String RCT_31_REF_CODE = record.getAs("RCT_31_REF_CODE");
                String RCT_31_REF_DESC = record.getAs("RCT_31_REF_DESC");
