...
public class RCT_27_DF {

	public static void main(String[] args) {
		
		System.out.println("RCT => REF_REC_TYPE = '27'");
		...
		Dataset<Row> RCT_27 = MRCT.select(MRCT.col("REF_CODE"), MRCT.col("REF_DESC"))
				.filter(MRCT.col("REF_REC_TYPE").equalTo(27))
		...
		Dataset<Row> RCT_27_DF  = RCT_27.flatMap(new FlatMapFunction<Row, Row>() {
            ...
            public Iterator<Row> call(Row record) throws Exception {
                String RCT_27_REF_CODE = record.getAs("RCT_27_REF_CODE");
                String RCT_27_REF_DESC = record.getAs("RCT_27_REF_DESC");
