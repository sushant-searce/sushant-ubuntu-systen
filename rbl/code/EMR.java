...
public class EMR {
	...
	public static void main(String[] args) {
		...
		SparkSession spark = SparkSession.builder().appName("RBL Spark ETL Job")
				.config("spark.sql.crossJoin.enabled", "true").getOrCreate();
		
		String outPath = "https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/outDF.csv";
		
		// 1. ACT - Starts
		printMessage("ACT----------------Starts");
		Dataset<Row> acd = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/acd.txt").select("B2K_ID","MAIN_CLASSIFICATION_USER");
		// acd.show();
		...
		Dataset<Row> adt = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/ADT.txt");
		// adt.show();
		...
		Dataset<Row> alr = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/ALR.txt");
		// alr.show();
		...
		Dataset<Row> c_dbc = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/C_DBC.txt").select("FORACID", "DEBIT_CARD");;
		// c_dbc.show();
		...
		Dataset<Row> c_gam = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/C_GAM.txt");
		// c_gam.show();
		...
		Dataset<Row> cam = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/CAM.txt");
		// cam.show();
		...
		Dataset<Row> cfcm = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/cfcm.txt")
				.select("ENTITY_ID","FREE_CODE_20","FREE_CODE_22","FREE_CODE_21"
		...
		Dataset<Row> cot = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/cot.txt");
		// cot.show();
		...
		Dataset<Row> eit = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/EIT.txt");
		// eit.show();
		...
		Dataset<Row> GAC_DF = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/GAC.txt");
		// gac.show();
		...
		Dataset<Row> gam = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/gam.txt");
		// gam.show();
		...
		Dataset<Row> gct = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/GCT.txt");
		// gct.show();
		...
		Dataset<Row> gem = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/GEM.txt");
		// gem.show();
		...
		Dataset<Row> gsh = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/GSH.txt");
		// gsh.show();
		...
		Dataset<Row> gsp = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/gsp.txt");
		// gsp.show();
		...
		Dataset<Row> htd = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/htd.txt");
		// htd.show();
		...
		Dataset<Row> itc = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/ITC.txt");
		// itc.show();
		...
		Dataset<Row> lht = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/lHT.txt");
		// lht.show();
		...
		Dataset<Row> llt = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/llt.txt");
		// llt.show();
		...
		Dataset<Row> lrp = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/LRP.txt");
		// lrp.show();
		...
		Dataset<Row> rct = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/rct.txt");
		// rct.show();
	...
	//	Dataset<Row> rctDF = spark.sql("SELECT count(*) as cnt FROM RCT");
		...
		Dataset<Row> sct = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/SCT.txt");
		// sct.show();
		...
		Dataset<Row> svsuser_nsigncustinfo = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/SVSUSER_NSIGNCUSTINFO.txt");
		...
		Dataset<Row> svsuser_signcustinfo = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/SVSUSER_SIGNCUSTINFO.txt");
		...
		Dataset<Row> ta_cot = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/TA_COT.txt");
		// ta_cot.show();
		...
		Dataset<Row> tam = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/TAM.txt")
				.select("ACID", "CLOSE_ON_MATURITY_FLG","AUTO_RENEWAL_FLG","DEPOSIT_PERIOD_MTHS","DEPOSIT_PERIOD_DAYS"
		...
		Dataset<Row> lam = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/LAM.txt");
		// lam.show();
		...
		Dataset<Row> sol = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/sol.txt");
		// sol.show();
		...
		Dataset<Row> smt = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources/smt.txt");
		// smt.show();
		...
		Dataset<Row> LA_SAM_DF = spark.read().format("com.databricks.spark.csv").option("delimiter", "|")
				.option("header", "true").load("resources/https://sushant-test-rbl.s3.us-east-2.amazonaws.com/resources.txt");
		// la_sam.show();
