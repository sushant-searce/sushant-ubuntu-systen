...
public class RCT_38_DF {

	public static void main(String[] args) {
		
		System.out.println("RCT => REF_REC_TYPE = '38'");
		...
		Dataset<Row> RCT_38 = MRCT.select(MRCT.col("REF_CODE"), MRCT.col("REF_DESC"))
				.filter(MRCT.col("REF_REC_TYPE").equalTo("38"))
		...
		Dataset<Row> RCT_38_DF  = RCT_38.flatMap(new FlatMapFunction<Row, Row>() {
            ...
            public Iterator<Row> call(Row record) throws Exception {
                String RCT_38_REF_CODE = record.getAs("RCT_38_REF_CODE");
                String RCT_38_REF_DESC = record.getAs("RCT_38_REF_DESC");
