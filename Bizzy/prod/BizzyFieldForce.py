...
dag = DAG('BFF_callplan_prod_Airflow', default_args=default_args, schedule_interval="*/70 * * * *")
...
def upsert(tablename,columnname,primary_key_column, **kwargs):
    return RedshiftUpsertOperatorProd(Thison",
