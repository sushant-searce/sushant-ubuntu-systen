...
CREATE TABLE farmerdb_prod_cdc.answer_type(
    id INTEGER NOT NULL ,
...
CREATE TABLE farmerdb_prod_cdc.cash_in_transit(
    id BIGINT NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.customer_order(
    id BIGINT NOT NULL ,
...
CREATE TABLE farmerdb_prod_cdc.noo_address(
    id BIGINT NOT NULL ,
...
CREATE TABLE farmerdb_prod_cdc.noo_image(
    id BIGINT NOT NULL,
    noo_profile_id BIGINT NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.noo_profile(
    id BIGINT NOT NULL ,
    noo_id BIGINT NOT NULL,
    cust_id BIGINT NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.order_detail(
    id BIGINT NOT NULL ,
...
CREATE TABLE farmerdb_prod_cdc.order_process(
    id BIGINT NOT NULL ,
    sales_id_sys VARCHAR(10) NOT NULL,
    customer_name VARCHAR(40) NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.prod_uom_detail(
    id INTEGER NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.stock_taking(
    id INTEGER NOT NULL ,
    salesman_id BIGINT NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.stock_taking_detail(
    id INTEGER NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.survey(
    id INTEGER NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.survey_answer(
    id INTEGER NOT NULL ,
    customer_id BIGINT NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.survey_question(
    id INTEGER NOT NULL ,
    survey_id INTEGER NOT NULL,
...
CREATE TABLE farmerdb_prod_cdc.survey_sales_office(
    survey_id INTEGER NOT NULL,
