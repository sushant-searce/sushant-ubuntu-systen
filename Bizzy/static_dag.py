...
from airflow.operators.bizzy_redshift_upsert_plugin import BizzyRedshiftUpsertOperator
from airflow.operators.bizzy_redshift_load_plugin import BizzyS3ToRedshiftOperator
...
upsert = BizzyRedshiftUpsertOperator(
  task_id='upsert',
...
load = BizzyS3ToRedshiftOperator(
  task_id="load",
