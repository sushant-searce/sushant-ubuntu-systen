...
class S3ToRedshiftOperatorProduction(BaseOperator):
    ...
    def __init__(self, redshift_conn_id,table,s3_bucket,s3_path,region,*args, **kwargs):
        ...
        super(S3ToRedshiftOperatorProduction, self).__init__(*args, **kwargs)
       ...
       # Convert to Asia/Jakarta time zone
        ...
        try:
            ...
            if 'Contents' in response:
                ...
                self.main_prefix+"."+self.table, self.s3_bucket, s3_past_two_hour_path, self.iam_role, s3_copy_format)
...
class S3ToRedshiftOperatorPluginProd(AirflowPlugin):
    ...
    name = "redshift_load_plugin_mssql"

    operators = [S3ToRedshiftOperatorProduction]
