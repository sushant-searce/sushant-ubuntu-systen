...
dag = DAG('excel_truncate_dag', default_args=default_args, schedule_interval=None)

s3_client = boto3.client('s3')
response = s3_client.list_objects_v2(Bucket='prod-datalake-raw-data',Prefix='excel-datasource/truncate-dag/excel-file')
...
test_task = PythonOperator(
    ...
    op_kwargs={
        ...
        'xlPath':'excel-datasource/truncate-dag/excel-file',
        'xlName':result,
        'csvPath':'excel-datasource/truncate-dag/csv-file'
    })

response_csv = s3_client.list_objects_v2(Bucket='prod-datalake-raw-data',Prefix='excel-datasource/truncate-dag/csv-file')
...
csv_file_name = "excel-datasource/truncate-dag/csv-file/"+result_csv
...
select * from schema_details where db_name='excel_testing' and table_name='employee'
"""
