...
dag = DAG('cargowise-stmalog-batch', default_args=default_args,schedule_interval=None)
...
select * from cargowise_table where db_name='OdysseyPTBPRD' and table_name in ('StmALog')
"""
