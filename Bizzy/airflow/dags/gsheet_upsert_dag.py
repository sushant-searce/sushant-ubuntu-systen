...
dag = DAG('gsheet_upsert_dag', default_args=default_args, schedule_interval=None)
...
test_task = PythonOperator(
    ...
    op_kwargs={
        ...
        'csvPath':'excel-datasource/gsheet-upsert-dag/csv-file'
    })

response_csv = s3_client.list_objects_v2(Bucket='prod-datalake-raw-data',Prefix='excel-datasource/gsheet-upsert-dag/csv-file')
...
csv_file_name = "excel-datasource/gsheet-upsert-dag/csv-file/"+result_csv
...
select * from schema_details where db_name='excel_testing' and table_name='employee_details_gsheet'
"""
